...
/*
    -Nella classe AmministratoreController vengono gestiti ed organizzati tutti gli endpoint relativi all'amministratore.
    ...
    -Nei metodi presenti in questa classe vengono semplicemente richiamati i metodi dela classe AministratoreService
...
public class AmministratoreController {
    ...
    /**
     * In questo metodo viene implmenetata la logica dell'annotazione @Autowired per l'attributo amministratoreService,
